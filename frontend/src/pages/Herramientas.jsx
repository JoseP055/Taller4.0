...
function NuevaHerramientaModal({ meta, onClose, onSaved }) {
  ...
  async function submit(e) {
    ...
    try {
      await fetchApi('/herramientas/alta-rapida', {
        method: 'POST',
        body: {
      ...
      setError(e2?.message || 'No se pudo crear la herramienta')
    } finally {
    ...
    <div className="modal-overlay" role="dialog" aria-modal="true">
      <div className="modal">
        <div className="modal-head">
          <div className="modal-title">Nueva herramienta</div>
...
export default function Herramientas() {
  ...
  const [nuevaHerramientaModalOpen, setNuevaHerramientaModalOpen] = useState(false)
  ...
  return (
    <section className="inv-page">
          ...
          <div className="table-top">
            ...
            <div className="actions">
              <button
                className="primary"
                type="button"
                onClick={() => setNuevaHerramientaModalOpen(true)}
      ...
      {nuevaHerramientaModalOpen ? (
        <NuevaHerramientaModal
          meta={meta}
          onClose={() => setNuevaHerramientaModalOpen(false)}
          onSaved={() => {
            setNuevaHerramientaModalOpen(false)
            setRefreshKey((k) => k + 1)
          }}
        />
      ) : null}
