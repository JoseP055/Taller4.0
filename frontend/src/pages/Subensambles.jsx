...
const KIND = 'subensambles'
const FIXED_LOCATION_CODE = 'SUBENSAMBLE'
...
function ItemModal({ meta, onClose, onSave }) {
  ...
  const locationLabel = useMemo(() => {
    const found = ubis.find((u) => u.codigo === FIXED_LOCATION_CODE)
    if (found && found.nombre) return `${FIXED_LOCATION_CODE} — ${found.nombre}`
    ...
    <div className="modal-overlay" role="dialog" aria-modal="true">
      <div className="modal">
        <div className="modal-head">
          <div className="modal-title">Agregar subensamble</div>
        ...
        <form className="modal-body" onSubmit={submit}>
          <div className="form-grid">
            ...
            <label className="field">
              <span>Ubicación</span>
              <input value={locationLabel} disabled />
            </label>
    ...
    <section className="inv-page">
      <div className="inv-head">
        ...
        <div className="inv-title-row">
          <h2 className="inv-title">Subensambles</h2>
      ...
      <div className="section-title">Subensambles</div>
      <div className="stats">
        <StatCard
